      ...
      <form onSubmit={handleBookSubmit} className="flex lg:w-[1180px] flex-col flex-wrap gap-4">
        <div className="flex gap-8">
          ...
          <div className='lg:w-1/2'>
            ...
            <TextInput id="bookAuthor" name="bookAuthor" type="text" placeholder="Book Author" required />
          </div>
        </div>
        <div className="flex gap-8">
          <div className='lg:w-1/2'>
        ...
        <div className="flex gap-8">
          <div className='w-full'>
            ...
            <Textarea id="bookDescription" name="bookDescription" type="text" placeholder="Book Description" required rows={4} />
          </div>
          <div className='w-full'>
            <div className="mb-2 block">
